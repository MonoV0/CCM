...
コントロールパネル、プリセット、ブロック/サブ管理者、チケット招待、
配信告知、リアクションパネルなど、UIコンポーネント全般をここに置く。
"""
import re
...
from bot_core import log
from utils import generate_log_file, generate_ticket, detect_platform
